...
public class Project extends Resource {
	...
	public String toString() {
		return "Project [key=" + key + ", name=" + name + ", description="
				+ description + ", lead=" + lead + ", assigneeType="
				+ assigneeType + ", components=" + components + ", issueTypes="
				+ issueTypes + ", versions=" + versions + ", roles=" + roles
