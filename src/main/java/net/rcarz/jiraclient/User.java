...
public class User extends Resource {
     ...
     * @throws JiraException when the retrieval fails
     */    
    public static List<User> getAll(RestClient restclient, String project) throws JiraException {
        JSON result = null;
        ...
        try {
        	result = restclient.get(getBaseUri() + "user/assignable/search", params);
        } catch (Exception ex) {
	...
	public String toString() {
		return "User [active=" + active + ", displayName=" + displayName + ", email=" + email
				+ ", name=" + name + "]";
	}
